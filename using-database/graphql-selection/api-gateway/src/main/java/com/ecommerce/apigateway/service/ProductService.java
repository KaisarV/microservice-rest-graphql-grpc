...
public class ProductService {
    ...
    public Product saveProduct(ProductRequest productRequest) {
        String mutation = String.format(
                "mutation { addProduct(productRequest: { " +
                        "id: %s, " +
                        "productCode: \\\"%s\\\", " +
                        "productTitle: \\\"%s\\\", " +
                        "imageUrl: \\\"%s\\\", " +
                        "discountOffer: %f, price: %f }) { productTitle, imageUrl, price }}",
        ...
        return executeGraphQLMutation(mutation, "addProduct");
    }

    private <T> T executeGraphQLMutation(String mutation, String rootField) {
        String response = performHttpPostRequest(mutation);
        return parseGraphQLResponse(response, rootField, (Class<T>) Product.class);
    }
    ...
    public Product updatePrice(Integer productId, Double price) {
        ...
        return executeGraphQLMutation(mutation, "addPrice");
    }
