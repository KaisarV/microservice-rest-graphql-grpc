...
public class OfferService {
    ...
    public Product addProductOffer(OfferRequest offerRequest) {
        String mutation = String.format(
                "mutation { addOffer(offerRequest: { id: %s, productId: %s, discountOffer: %f }) { id, productCode, productTitle, imageUrl, discountOffer, price, currentPrice }}",
                offerRequest.getId(),
    ...
    public ResponseTemplateVO getOfferWithProduct(Integer id) {
        String query = String.format("query { offerWithProduct(id: %d) { offer { id, productId, discountOffer }, product { id, productCode, productTitle, imageUrl, discountOffer, price, currentPrice }}}", id);
